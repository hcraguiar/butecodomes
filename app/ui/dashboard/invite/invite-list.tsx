    ...
    <>
      ...
      {invites.length === 0 ? (
        ...
        invites.map((invite) => {
          ...
          return (
            <div
              className="rounded-md p-4 flex flex-col bg-session dark:bg-dark-session shadow-sm mb-2"
              key={invite.id}
            >
              <p className="text-sm">
...
//         <div className="rounded-md p-4 flex flex-col bg-session dark:bg-dark-session shadow-sm mb-2" key={invite.id}>
//           <p className="text-sm">
//             Token: <span className="font-mono">{invite.token.slice(0, 8)}...</span>
//           </p>
//           <p className="text-xs text-gray-500">
