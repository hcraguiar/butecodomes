...
export default function SummaryStats({ totalReviews, totalCheckIns, totalVisited }: Props) {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
      <div className="col-span-2 sm:col-span-1 bg-session shadow rounded-2xl p-4 flex items-center gap-4">
      ...
      <div className="bg-session shadow rounded-2xl p-4 flex items-center gap-4">
