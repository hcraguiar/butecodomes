...
export default function GoogleSignInButton() {
  return (
    <div className="rounded-lg bg-gray-50 px-6 py-4 mt-2">
      <form 
        action={async () => {
          "use server"
          await signIn("google",  { callbackUrl: `${process.env.NEXT_PUBLIC_URL}/dashboard` });
        }}
        >
...
{/* <div class="MikQqe">
  ...
  <div class="kHn9Lb">Fazer login com o Google</div>
</div> */}
